...
$multiServiceGraphs->{Linux}->{fs}->{fsUtilization} = $obj;
...
$multiServiceGraphs->{Linux}->{io}->{ioActivity} = $obj;
...
$multiServiceGraphs->{Linux}->{io}->{ioUtilization} = $obj;
...
$multiServiceGraphs->{Linux}->{io}->{ioWait} = $obj;
...
$multiServiceGraphs->{Linux}->{tcp}->{tcpUtilization} = $obj;
