...
$obj2 = GraphMetric->new(       name => "bytesInSec",
                                                color           => "#0000FF",
                                                lineType        => "LINE2",
                                                gprintArray     => [qw{AVERAGE LAST}],
                                                cDefinition     => "",
                                                );
$obj->addGraphMetric("bytesInSec", $obj2);

$obj2 = GraphMetric->new(       name => "bytesOutSec",
                                                color           => "#FF0000",
                                                lineType        => "LINE2",
                                                gprintArray     => [qw{AVERAGE LAST}],
                                                cDefinition     => "",
                                                );
$obj->addGraphMetric("bytesOutSec", $obj2);

$service->addGraph("tcpUtilization", $obj);
