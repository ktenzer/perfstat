...
$singleServiceGraphs->{Linux}->{cpu}->{cpuLoad} = $obj;
...
$singleServiceGraphs->{Linux}->{cpu}->{cpuUtilization} = $obj;
...
$singleServiceGraphs->{Linux}->{fs}->{fsUtilization} = $obj;
...
$singleServiceGraphs->{Linux}->{io}->{ioActivity} = $obj;
...
$singleServiceGraphs->{Linux}->{io}->{ioUtilization} = $obj;
...
$singleServiceGraphs->{Linux}->{io}->{ioWait} = $obj;
...
$singleServiceGraphs->{Linux}->{mem}->{memUtilization} = $obj;
...
$singleServiceGraphs->{Linux}->{mem}->{swapUtilization} = $obj;
...
$singleServiceGraphs->{Linux}->{mem}->{memPaging} = $obj;
...
$singleServiceGraphs->{Linux}->{procs}->{procsActivity} = $obj;
...
$singleServiceGraphs->{Linux}->{'socket'}->{socketActivity} = $obj;
...
$singleServiceGraphs->{Linux}->{tcp}->{tcpUtilization} = $obj;
...
$singleServiceGraphs->{Linux}->{uptime}->{uptime} = $obj;
