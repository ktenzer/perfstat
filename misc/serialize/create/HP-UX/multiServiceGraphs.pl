...
$multiServiceGraphs->{'HP-UX'}->{fs}->{fsUtilization} = $obj;
...
$multiServiceGraphs->{'HP-UX'}->{io}->{ioActivity} = $obj;
...
$multiServiceGraphs->{'HP-UX'}->{io}->{ioUtilization} = $obj;
...
$multiServiceGraphs->{'HP-UX'}->{io}->{ioWait} = $obj;
...
$multiServiceGraphs->{'HP-UX'}->{tcp}->{tcpUtilization} = $obj;
