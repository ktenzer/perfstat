...
$obj = Metric->new(	rrdIndex => 1,
					metricName => "disk_write_kb",
					friendlyName => "FS Disk Write KB",
					hasEvents => 0,
					warnThreshold => 0,
					critThreshold => 0,
					thresholdUnit => "?",
...
$obj = Metric->new(	rrdIndex => 3,
					metricName => "disk_read_kb",
					friendlyName => "FS Disk Read KB",
					hasEvents => 0,
					warnThreshold => 0,
					critThreshold => 0,
					thresholdUnit => "?",
