...
$obj = Metric->new(	rrdIndex => 0,
					metricName => "established",
					friendlyName => "Socket: est",
					hasEvents => 0,
					warnThreshold => 0,
					critThreshold => 0,
					thresholdUnit => "?",
...
$obj = Metric->new(	rrdIndex => 1,
					metricName => "active",
					friendlyName => "Socket: active",
					hasEvents => 1,
					warnThreshold => 100,
					critThreshold => 200,
					thresholdUnit => "total sockets active",
					);
$service->addMetric($obj);
...
$obj = Metric->new(	rrdIndex => 2,
					metricName => "passive",
					friendlyName => "Socket: passive",
					hasEvents => 0,
					warnThreshold => 0,
					critThreshold => 0,
					thresholdUnit => "total sockets passive",
					);
$service->addMetric($obj);
