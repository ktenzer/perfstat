...
$obj2 = GraphMetric->new(       name => "pageInSec",
                                                color           => "#FF0000",
                                                lineType        => "LINE2",
                                                gprintArray     => [qw{AVERAGE LAST}],
                                                cDefinition     => "",
                                                );
$obj->addGraphMetric("pageInSec", $obj2);

$obj2 = GraphMetric->new(       name => "pageOutSec",
                                                color           => "#FFFF00",
                                                lineType        => "LINE2",
                                                gprintArray     => [qw{AVERAGE LAST}],
                                                cDefinition     => "",
                                                );
$obj->addGraphMetric("pageOutSec", $obj2);
