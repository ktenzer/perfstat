...
$multiServiceGraphs->{WindowsNT}->{fs}->{fsUtilization} = $obj;
...
$multiServiceGraphs->{WindowsNT}->{io}->{ioActivity} = $obj;
...
$multiServiceGraphs->{WindowsNT}->{io}->{ioUtilization} = $obj;
...
$multiServiceGraphs->{WindowsNT}->{io}->{ioWait} = $obj;
...
$multiServiceGraphs->{WindowsNT}->{tcp}->{tcpUtilization} = $obj;
