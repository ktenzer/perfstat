...
$singleServiceGraphs->{WindowsNT}->{cpu}->{cpuLoad} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{cpu}->{cpuUtilization} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{fs}->{fsUtilization} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{io}->{ioActivity} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{io}->{ioUtilization} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{io}->{ioWait} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{mem}->{memUtilization} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{mem}->{swapUtilization} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{mem}->{memPaging} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{procs}->{procsActivity} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{'socket'}->{socketActivity} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{tcp}->{tcpUtilization} = $obj;
...
$singleServiceGraphs->{WindowsNT}->{uptime}->{uptime} = $obj;
