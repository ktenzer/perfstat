...
$obj2 = GraphMetric->new(       name => "activeOpens",
                                                color           => "#FFA500",
                                                lineType        => "LINE2",
                                                gprintArray     => [qw{AVERAGE LAST}],
                                                cDefinition     => "",
                                                );
$obj->addGraphMetric("activeOpens", $obj2);

$obj2 = GraphMetric->new(       name => "passiveOpens",
                                                color           => "#FF0000",
                                                lineType        => "LINE2",
                                                gprintArray     => [qw{AVERAGE LAST}],
                                                cDefinition     => "",
                                                );
$obj->addGraphMetric("passiveOpens", $obj2);

$obj2 = GraphMetric->new(       name => "estConnections",
                                                color           => "#0000FF",
                                                lineType        => "LINE2",
                                                gprintArray     => [qw{AVERAGE LAST}],
                                                cDefinition     => "",
                                                );
$obj->addGraphMetric("estConnections", $obj2);

$service->addGraph("socketActivity", $obj);
