...
$obj = Graph->new(	name   => "load",
					...
					defArray => [q{DEF:cpu_load_1=$RRD:cpu_load_1:AVERAGE},q{DEF:cpu_load_5=$RRD:cpu_load_5:AVERAGE},q{DEF:cpu_load_15=$RRD:cpu_load_15:AVERAGE}],
					cdefArray => [],
					lineArray => [qq{LINE2:cpu_load_1#FF0000:1 Min Load},qq{LINE2:cpu_load_5#FFFF00:5 Min Load},qq{LINE2:cpu_load_15#00CC00:15 Min Load}],
					text    => "",
					);
