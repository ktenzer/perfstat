...
$singleServiceGraphs->{SunOS}->{cpu}->{cpuLoad} = $obj;
...
$singleServiceGraphs->{SunOS}->{cpu}->{cpuUtilization} = $obj;
...
$singleServiceGraphs->{SunOS}->{fs}->{fsUtilization} = $obj;
...
$singleServiceGraphs->{SunOS}->{io}->{ioActivity} = $obj;
...
$singleServiceGraphs->{SunOS}->{io}->{ioUtilization} = $obj;
...
$singleServiceGraphs->{SunOS}->{io}->{ioWait} = $obj;
...
$singleServiceGraphs->{SunOS}->{mem}->{memUtilization} = $obj;
...
$singleServiceGraphs->{SunOS}->{mem}->{swapUtilization} = $obj;
...
$singleServiceGraphs->{SunOS}->{mem}->{memPaging} = $obj;
...
$singleServiceGraphs->{SunOS}->{procs}->{procsActivity} = $obj;
...
$singleServiceGraphs->{SunOS}->{'socket'}->{socketActivity} = $obj;
...
$singleServiceGraphs->{SunOS}->{tcp}->{tcpUtilization} = $obj;
...
$singleServiceGraphs->{SunOS}->{uptime}->{uptime} = $obj;
