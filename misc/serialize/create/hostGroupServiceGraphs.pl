...
$hostGroupServiceGraphs->{cpu}->{cpuLoad} = $obj;
...
$hostGroupServiceGraphs->{cpu}->{cpuUtilization} = $obj;
...
$hostGroupServiceGraphs->{fs}->{fsUtilization} = $obj;
...
$hostGroupServiceGraphs->{io}->{ioActivity} = $obj;
...
$hostGroupServiceGraphs->{io}->{ioUtilization} = $obj;
...
$hostGroupServiceGraphs->{io}->{ioWait} = $obj;
...
$hostGroupServiceGraphs->{mem}->{memUtilization} = $obj;
...
$hostGroupServiceGraphs->{mem}->{swapUtilization} = $obj;
...
$hostGroupServiceGraphs->{mem}->{memPaging} = $obj;
...
$hostGroupServiceGraphs->{procs}->{procsActivity} = $obj;
...
$hostGroupServiceGraphs->{'socket'}->{socketActivity} = $obj;
...
$hostGroupServiceGraphs->{tcp}->{tcpUtilization} = $obj;
...
$hostGroupServiceGraphs->{uptime}->{uptime} = $obj;

lock_store($hostGroupServiceGraphs, "$perfhome/var/db/mappings/hostGroupServiceGraphs.ser") || die("can't store $hostGroupServiceGraphs in hostGroupServiceGraphs.ser\n");
