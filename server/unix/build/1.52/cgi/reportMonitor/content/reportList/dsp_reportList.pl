...
print("						<tr>\n");
my $formula6=$queryString;print("							<th nowrap=\"nowrap\"><a href=\"../viewReport/index.pl?$formula6\">View</a></th>\n");
my $formula7=$queryString;my $formula8=$reportName;print("							<th nowrap=\"nowrap\"><a href=\"../editReport/index.pl?$formula7&reportNameID=$formula8\">Edit</a></th>\n");
my $formula9=$queryString;print("							<th nowrap=\"nowrap\"><a href=\"../shareReport/index.pl?$formula9\">Share</a></th>\n");
my $formula10=$queryString;my $formula11=$reportName;print("							<th nowrap=\"nowrap\"><a href=\"index.pl?action=deleteReport&$formula10\" onclick=\"return warnOnClickAnchor('Are you sure you want to delete $formula11');\">Delete</a></th>\n");
print("						</tr>\n");
print("					</table>\n");
print("				</td>\n");
my $formula12=$reportName;print("				<td class=\"liteGray\" align=\"left\" valign=\"top\"><span class=\"table1Text1\">$formula12</span></td>\n");
my $formula13=$reportDescription;print("				<td class=\"liteGray\" valign=\"top\" align=\"left\"><span class=\"table1Text2\">$formula13</span></td>\n");
print("			</tr>\n");
}
}
print("		</table>\n");
...
print("							<table cellpadding=\"1\" cellspacing=\"1\" border=\"0\" class=\"table2\">\n");
print("								<tr>\n");
my $formula14=$queryString;print("									<th nowrap=\"nowrap\"><a href=\"../viewReport/index.pl?$formula14\">View</a></th>\n");
print("								</tr>\n");
print("							</table>\n");
print("						</td>\n");
my $formula15=$reportOwner;print("						<td class=\"liteGray\" align=\"left\" valign=\"top\"><span class=\"table1Text1\">$formula15</span></td>\n");
my $formula16=$reportName;print("						<td class=\"liteGray\" align=\"left\" valign=\"top\"><span class=\"table1Text1\">$formula16</span></td>\n");
my $formula17=$reportDescription;print("						<td class=\"liteGray\" valign=\"top\" align=\"left\"><span class=\"table1Text2\">$formula17</span></td>\n");
print("					</tr>\n");
}
}
print("		</table>\n");
