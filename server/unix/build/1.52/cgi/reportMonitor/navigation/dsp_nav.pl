...
print("	</head>\n");
my $formula0=$doOnBodyLoad;print("	<body onLoad=\"onBodyLoad('$formula0');\">\n");
...
print("				<tr>\n");
print("					<td><img src=\"../../perfStatResources/images/navigation/icon_reportMonitor2.gif\" border=\"0\" width=\"19\" height=\"19\"></td>\n");
...
print("					<td><img src=\"../../perfStatResources/images/navigation/icon_reportMonitor1.gif\" border=\"0\" width=\"19\" height=\"19\"></td>\n");
...
print("			<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\">\n");
print("				<tr>\n");
print("					<td><img name=\"xallHosts_host1\" src=\"../../perfStatResources/images/common/spacer.gif\" border=\"0\" width=\"9\" height=\"9\"></td>\n");
...
print("				<tr>\n");
print("					<td><img name=\"xallHosts_host1\" src=\"../../perfStatResources/images/common/spacer.gif\" border=\"0\" width=\"9\" height=\"9\"></td>\n");
my $formula20=$queryString;my $formula21=$reportName;print("					<td><a href=\"../content/editReport/index.pl?$formula20&reportNameID=$formula21\" target=\"content\">Edit</a></td>\n");
print("				</tr>\n");
print("			</table>\n");
print("			<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\">\n");
print("				<tr>\n");
print("					<td><img name=\"xallHosts_host1\" src=\"../../perfStatResources/images/common/spacer.gif\" border=\"0\" width=\"9\" height=\"9\"></td>\n");
my $formula22=$queryString;print("					<td><a href=\"../content/shareReport/index.pl?$formula22\" target=\"content\">Share</a></td>\n");
print("				</tr>\n");
print("			</table>\n");
print("			<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\">\n");
print("				<tr>\n");
print("					<td><img name=\"xallHosts_host1\" src=\"../../perfStatResources/images/common/spacer.gif\" border=\"0\" width=\"9\" height=\"9\"></td>\n");
my $formula23=$queryString;print("					<td><a href=\"../content/reportList/index.pl?action=deleteReport&$formula23\" target=\"content\">Delete</a></td>\n");
print("				</tr>\n");
print("			</table>\n");
}
print("			</div>\n");
