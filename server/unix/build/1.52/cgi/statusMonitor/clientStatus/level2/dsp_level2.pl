...
print("			<tr>\n");
my $formula2=$hostDescHash->{'OS'};print("				<td class=\"liteGray\" align=\"center\" valign=\"top\" height=\"50\" width=\"48\"><img src=\"../../../perfStatResources/images/osIcons/$formula2/icon.gif\" width=\"36\" height=\"38\" alt=\"No new posts\" title=\"No new posts\" /></td>\n");
...
print("								<table cellpadding=\"1\" cellspacing=\"1\" border=\"0\" class=\"table2\" width=\"100%\">\n");
print("									<tr>\n");
my $formula13=$hostName;my $formula14=$hostServiceHashKey;my $formula15=$hostName;my $formula16=$hostServiceHashKey;my $formula17=$hostName;my $formula18=$hostServiceHashKey;my $formula19=$hostServiceHashKey;print("										<th nowrap=\"nowrap\" valign=\"middle\" align=\"left\"><a href=\"javascript:toggle('$formula13-$formula14-off', '$formula15-$formula16-on');\"><img id=\"x$formula17-$formula18-off\" src=\"../../../perfStatResources/images/navigation/icon_plusNavBar.gif\" width=\"9\" height=\"9\" border=\"0\"></a>&nbsp;$formula19</th>\n");
print("									</tr>\n");
print("									<tr>\n");
print("										<td valign=\"top\" align=\"center\">\n");
my $formula20=$hostName;my $formula21=$hostServiceHashKey;print("											<div id=\"$formula20-$formula21-off\" style=\"display:block;\">\n");
my $formula22=$serviceDescHash->{'status'};print("												<img src=\"../../../perfStatResources/images/content/status_$formula22.gif\" width=\"20\" height=\"20\" /></div>\n");
...
my $formula30=$subServiceHash->{$subServiceHashKey};print("														<td><img src=\"../../../perfStatResources/images/content/status_$formula30.gif\" width=\"20\" height=\"20\" /></td>\n");
print("													</tr>\n");
}
print("												</table>\n");
print("											</div>\n");
