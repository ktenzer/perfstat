...
print("		<script language=\"javascript\" src=\"../../../appRez/javaScripts/sm.level3.js\"></script>\n");
print("	</head>\n");
...
print("										</tr>\n");
print("										<tr>\n");
my $formula7=$sessionObj->param("hostGroupID");my $formula8=$sessionObj->param("hostName");my $formula9=$serviceHashRefinedKey;my $formula10=$serviceDescHash->{'status'};print("											<td valign=\"top\" align=\"center\"><a href=\"index.pl?hostGroupID=$formula7&hostName=$formula8&serviceName=$formula9\"><img src=\"../../../appRez/images/content/status_$formula10.gif\" width=\"20\" height=\"20\" /></a></td>\n");
print("										</tr>\n");
print("									</table>\n");
} else {
...
print("									<table cellpadding=\"1\" cellspacing=\"1\" border=\"0\" class=\"table2\" width=\"100%\">\n");
print("										<tr>\n");
my $formula11=$serviceHashRefinedKey;my $formula12=$serviceHashRefinedKey;my $formula13=$serviceHashRefinedKey;my $formula14=$serviceHashRefinedKey;print("											<th nowrap=\"nowrap\" valign=\"middle\" align=\"left\"><a href=\"javascript:toggle('$formula11-off', '$formula12-on');\"><img id=\"x$formula13-off\" src=\"../../../appRez/images/navigation/icon_plusNavBar.gif\" width=\"9\" height=\"9\" border=\"0\"></a>&nbsp;$formula14</th>\n");
print("										</tr>\n");
print("										<tr>\n");
print("											<td valign=\"top\" align=\"center\">\n");
my $formula15=$serviceHashRefinedKey;print("												<div id=\"$formula15-off\" style=\"display:block;\">\n");
my $formula16=$serviceDescHash->{'status'};print("													<img src=\"../../../appRez/images/content/status_$formula16.gif\" width=\"20\" height=\"20\" />\n");
print("												</div>\n");
...
my $formula23=$subServiceHash->{$subServiceHashKey};print("															<td><img src=\"../../../appRez/images/content/status_$formula23.gif\" width=\"20\" height=\"20\" /></td>\n");
print("														</tr>\n");
}
print("													</table>\n");
print("												</div>\n");
...
my $formula30=$status;print("				<td class=\"darkGray\" valign=\"middle\" align=\"center\"><img src=\"../../../appRez/images/content/status_$formula30.gif\" width=\"20\" height=\"20\"></td>\n");
print("			</tr>\n");
}
}
print("			<tr>\n");
