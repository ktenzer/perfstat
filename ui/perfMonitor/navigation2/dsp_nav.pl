...
print("		<script language=\"javascript\" src=\"../../appRez/javaScripts/pm.nav.js\"></script>\n");
print("	</head>\n");
...
print("							<td>\n");
if ($hasGraphs == 0) {
print("									<img src=\"../../appRez/images/common/spacer.gif\" border=\"0\" width=\"9\" height=\"9\">\n");
} else {
my $formula1=$hostGroupMember;my $formula2=$hostGroupMember;my $formula3=$hostGroupMember;print("									<a id=\"x$formula1\" href=\"javascript:Toggle('$formula2');\"><img name=\"x$formula3\" src=\"../../appRez/images/navigation/icon_plusNavBar.gif\" border=\"0\"></a>\n");
}
print("							</td>\n");
...
print("								<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\">\n");
print("									<tr>\n");
print("										<td><img src=\"../../appRez/images/common/spacer.gif\" height=\"10\" width=\"9\" border=\"0\"></td>\n");
print("										<td><img src=\"../../appRez/images/navigation/icon_performanceMonitor2.gif\" border=\"0\"></td>\n");
...
print("									<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\">\n");
print("										<tr>\n");
my $formula40=$idString;my $formula41=$idString;my $formula42=$idString;print("											<td><a id=\"x$formula40\" href=\"javascript:Toggle('$formula41');\"><img name=\"x$formula42\" src=\"../../appRez/images/navigation/icon_plusNavBar.gif\" border=\"0\"></a></td>\n");
print("											<td><img src=\"../../appRez/images/navigation/icon_statusMonitor3.gif\" border=\"0\"></td>\n");
