...
print("		<script language=\"javascript\" src=\"../../../appRez/javaScripts/pm.selectHostGraphs.js\"></script>\n");
print("	</head>\n");
...
print("							<td nowrap><img src=\"../../../appRez/images/common/spacer.gif\" height=\"6\" width=\"6\" border=\"0\"></td>\n");
print("							<td nowrap><a href=\"javascript:closeAll();\">close all</a></td>\n");
print("							<td nowrap><img src=\"../../../appRez/images/common/spacer.gif\" height=\"5\" width=\"6\" border=\"0\"></td>\n");
...
print("										<tr>\n");
my $formula10=$serviceName;my $formula11=$serviceName;my $formula12=$serviceName;my $formula13=$serviceName;print("											<th nowrap=\"nowrap\" valign=\"middle\" align=\"left\"><a href=\"javascript:toggle('$formula10-off', '$formula11-on');\"><img id=\"x$formula12-off\" src=\"../../../appRez/images/navigation/icon_plusNavBar.gif\" width=\"9\" height=\"9\" border=\"0\"></a>&nbsp;$formula13</th>\n");
print("										</tr>\n");
print("									</table>\n");
print("								</div>\n");
...
print("									<table cellpadding=\"1\" cellspacing=\"1\" border=\"0\" class=\"table2\">\n");
print("										<tr>\n");
my $formula15=$serviceName;my $formula16=$serviceName;my $formula17=$serviceName;my $formula18=$serviceName;print("											<th nowrap=\"nowrap\" valign=\"middle\" align=\"left\"><a href=\"javascript:toggle('$formula15-off', '$formula16-on');\"><img id=\"x$formula17-on\" src=\"../../../appRez/images/navigation/icon_minusNavBar.gif\" width=\"9\" height=\"9\" border=\"0\"></a>&nbsp;$formula18</th>\n");
print("										</tr>\n");
print("										<tr>\n");
print("											<td valign=\"top\">\n");
...
print("									<table cellpadding=\"1\" cellspacing=\"1\" border=\"0\" class=\"table2\">\n");
print("										<tr>\n");
my $formula29=$serviceName;my $formula30=$serviceName;my $formula31=$serviceName;my $formula32=$serviceName;print("											<th nowrap=\"nowrap\" valign=\"middle\" align=\"left\"><a href=\"javascript:toggle('$formula29-off', '$formula30-on');\"><img id=\"x$formula31-off\" src=\"../../../appRez/images/navigation/icon_plusNavBar.gif\" width=\"9\" height=\"9\" border=\"0\"></a>&nbsp;$formula32</th>\n");
print("										</tr>\n");
print("									</table>\n");
print("								</div>\n");
...
print("									<table cellpadding=\"1\" cellspacing=\"1\" border=\"0\" class=\"table2\">\n");
print("										<tr>\n");
my $formula34=$serviceName;my $formula35=$serviceName;my $formula36=$serviceName;my $formula37=$serviceName;print("											<th nowrap=\"nowrap\" valign=\"middle\" align=\"left\"><a href=\"javascript:toggle('$formula34-off', '$formula35-on');\"><img id=\"x$formula36-on\" src=\"../../../appRez/images/navigation/icon_minusNavBar.gif\" width=\"9\" height=\"9\" border=\"0\"></a>&nbsp;$formula37</th>\n");
print("										</tr>\n");
...
print("												<table border=\"0\" cellpadding=\"1\" cellspacing=\"1\">\n");
print("													<tr>\n");
my $formula39=$serviceName;my $formula40=$serviceName;my $formula41=$serviceName;print("														<td><a href=\"javascript:toggle('$formula39-all-off', '$formula40-all-on');\"><img id=\"x$formula41-all-off\" src=\"../../../appRez/images/navigation/icon_plusNavBar.gif\" width=\"9\" height=\"9\" border=\"0\"></a></td>\n");
...
print("												<table border=\"0\" cellpadding=\"1\" cellspacing=\"1\">\n");
print("													<tr>\n");
my $formula43=$serviceName;my $formula44=$serviceName;my $formula45=$serviceName;print("														<td><a href=\"javascript:toggle('$formula43-all-off', '$formula44-all-on');\"><img id=\"x$formula45-all-on\" src=\"../../../appRez/images/navigation/icon_minusNavBar.gif\" width=\"9\" height=\"9\" border=\"0\"></a></td>\n");
print("														<td nowrap>ALL</td>\n");
print("													</tr>\n");
print("												</table>\n");
...
print("													<tr>\n");
print("														<td><img src=\"../../../appRez/images/common/spacer.gif\" width=\"12\" height=\"9\" border=\"0\"></td>\n");
...
print("												<table border=\"0\" cellpadding=\"1\" cellspacing=\"1\">\n");
print("													<tr>\n");
my $formula57=$serviceName;my $formula58=$subServiceName;my $formula59=$serviceName;my $formula60=$subServiceName;my $formula61=$serviceName;my $formula62=$subServiceName;print("														<td><a href=\"javascript:toggle('$formula57-$formula58-off', '$formula59-$formula60-on');\"><img id=\"x$formula61-$formula62-off\" src=\"../../../appRez/images/navigation/icon_plusNavBar.gif\" width=\"9\" height=\"9\" border=\"0\"></a></td>\n");
...
print("												<table border=\"0\" cellpadding=\"1\" cellspacing=\"1\">\n");
print("													<tr>\n");
my $formula66=$serviceName;my $formula67=$subServiceName;my $formula68=$serviceName;my $formula69=$subServiceName;my $formula70=$serviceName;my $formula71=$subServiceName;print("														<td><a href=\"javascript:toggle('$formula66-$formula67-off', '$formula68-$formula69-on');\"><img id=\"x$formula70-$formula71-on\" src=\"../../../appRez/images/navigation/icon_minusNavBar.gif\" width=\"9\" height=\"9\" border=\"0\"></a></td>\n");
