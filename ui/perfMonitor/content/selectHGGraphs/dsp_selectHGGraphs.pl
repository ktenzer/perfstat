...
print("		<script language=\"javascript\" src=\"../../../appRez/javaScripts/pm.selectHostGroupGraphs.js\"></script>\n");
print("	</head>\n");
...
print("			</tr>\n");
print("			<tr>\n");
print("				<td class=\"liteGray\" align=\"center\" valign=\"middle\">No Host Groups Found</td>\n");
print("			</tr>\n");
print("		</table>\n");
} else {
...
print("										<tr>\n");
my $formula9=$serviceName;my $formula10=$serviceName;my $formula11=$serviceName;my $formula12=$serviceName;print("											<th nowrap=\"nowrap\" valign=\"middle\" align=\"left\"><a href=\"javascript:toggle('$formula9-off', '$formula10-on');\"><img id=\"x$formula11-off\" src=\"../../../appRez/images/navigation/icon_plusNavBar.gif\" width=\"9\" height=\"9\" border=\"0\"></a>&nbsp;$formula12</th>\n");
print("										</tr>\n");
print("									</table>\n");
print("								</div>\n");
