...
use vars qw($action $adminName $adminList $defaultNotificationStruct
				$editFlag $notificationTemplateArray $lenNotificationTemplateArray
				$addName $addDescription $editName $editDescription $queryString);
