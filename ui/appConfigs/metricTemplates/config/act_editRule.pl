...
sub editNotifyRule {
	...
	#deserialize
	my $notificationTemplate = lock_retrieve("$perfhome/var/db/users/$adminName/notificationTemplates/$templateName.ser") or die("Could not lock_retrieve from $perfhome/var/db/users/$adminName/notificationTemplates/$templateName.ser\n");
	...
	# Serialize
	$notificationTemplate->lock_store("$perfhome/var/db/users/$adminName/notificationTemplates/$templateName.ser") or die "ERROR: Can't store $perfhome/var/db/users/$adminName/notificationTemplates/$templateName.ser\n";
}
